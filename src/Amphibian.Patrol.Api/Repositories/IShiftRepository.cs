...
namespace Amphibian.Patrol.Api.Repositories
{
    public interface IShiftRepository
    {
        ...
        Task<IEnumerable<ScheduledShiftAssignmentDto>> GetScheduledShiftAssignments(int patrolId, int? userId=null, DateTime? from = null, DateTime? to = null, ShiftStatus? status=null, int? scheduledShiftId = null, int? noOverlapWithExistingScheduleUserId=null, int? shiftId=null);
