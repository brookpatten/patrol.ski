<template>
  ...
  >
    <CSidebarBrand class="d-md-down-none" to="/">
      <h3 v-if="selectedPatrol==null">Patrol.Ski</h3>
    ...
    <CSidebarNav>
      ...
      <CSidebarNavItem v-if='hasPermission("MaintainUsers")'
        name='People' :to='{name:"People"}' icon='cil-people' />
      <CSidebarNavItem v-if='hasPermission("MaintainGroups")'
        name='Groups' :to='{name:"Groups"}' icon='cil-chart-pie' />
      ...
      <CSidebarNavItem v-if='hasPermission("MaintainPlans")'
        name='Training Plans' :to='{name:"Plans"}' icon='cil-grid' />
